<template>
  <main class="flex gap-5 max-md:flex-col max-md:gap-0 p-[20px]">
    ...
    <section class="flex flex-col mt-[10px] ml-5 w-6/12 max-md:ml-0 max-md:w-full">
      <img loading="lazy" src="/src/assets/img/Yandex.png" />
    </section>
  </main>
</template>
